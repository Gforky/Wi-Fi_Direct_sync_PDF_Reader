...
public class DecodeServiceBase implements DecodeService
{
    ...
    @Override
	public void decodePage(Object decodeKey, int pageNum, final DecodeCallback decodeCallback, RectF pageSliceBounds)
    {
        final DecodeTask decodeTask = new DecodeTask(pageNum, decodeCallback, decodeKey, pageSliceBounds);
    ...
    private class DecodeTask
    {
        ...
        private DecodeTask(int pageNumber, DecodeCallback decodeCallback, Object decodeKey, RectF pageSliceBounds)
        {
