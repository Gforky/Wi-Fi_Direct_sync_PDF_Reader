...
public class DocumentView extends View{
    ...
    public DocumentView(Context context, DecodingProgressModel progressModel, CurrentPageModel currentPageModel) {
        super(context);
    ...
    private void init() {
        ...
        isInitialized = true;
        invalidatePageSizes();
        System.out.println("!!!!!!!!!!!!!1"+pages.get(0).node.bitmap);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        System.out.println("!!!!!!!!!!!!!1"+pages.get(1).node.bitmap);
    }
    ...
    void invalidatePageSizes() {
        ...
        for (int i = 0; i < pages.size(); i++) {
            ...
            float pageHeight = page.getPageHeight(width);
